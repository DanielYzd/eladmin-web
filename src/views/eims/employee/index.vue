  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.code" clearable placeholder="员工编号" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        ...
        <el-select v-model="query.status" clearable placeholder="状态" style="width:185px" class="filter-item" @change="crud.toQuery">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="岗位">
            <el-select v-model="form.jobCode" style="width: 370px;" />
          </el-form-item>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="employeeJob" label="岗位编码">
          <template slot-scope="scope">
            <span>{{ scope.row.employeeJob?scope.row.employeeJob.jobCode:null }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="employeeJob" label="岗位名称">
          <template slot-scope="scope">
            <span>{{ scope.row.employeeJob?scope.row.employeeJob.jobName:null }}</span>
          </template>
        </el-table-column>
...
const defaultForm = { code: null, name: null, jobCode: null, age: null, sex: null, salary: null, idcard: null, subsidy: null, status: null, createBy: null, updateBy: null, createTime: null, updateTime: null }
export default {
  name: 'Employee',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '员工管理', url: 'api/employee', idField: 'code', sort: 'code,desc', crudMethod: { ...crudEmployee }})
  },
  data() {
    return {
      permission: {
